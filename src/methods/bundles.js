module.exports = function (instance, common) {
  return {
    create: function (Bundle, cb) {
      // create(Bundle[, cb])
      return common.postParams(`/people/${instance.user.username}/bundles/create.json`, Bundle, cb);
    },
    ...
    update: function (id, Bundle, cb) {
      // update(id, Bundle[, cb])
      return common.postParams(`/people/${instance.user.username}/bundles/${id}.json`, Bundle, cb);
    }
  };
};
