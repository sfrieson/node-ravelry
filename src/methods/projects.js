module.exports = function (instance, common) {
  return {
    ...
    create: function (Project, cb) {
      // create(Project[, cb])
      return common.postParams(`/projects/${instance.user.username}/create.json`, Project, cb);
    },
    createPhoto: function (id, params, cb) {
      // createPhoto(id, params[, cb])
      return common.postParams(`/projects/${instance.user.username}/${id}/create_photo.json`, params, cb);
    },
    ...
    reorderPhotos: function (id, params, cb) {
      ...
      return common.postParams(`/projects/${instance.user.username}/${id}/reorder_photos.json`, params, cb);
    },
    ...
    update: function (id, Project, cb) {
      ...
      return common.postParams(`/projects/${instance.user.username}/${id}.json`, Project, cb);
    }
  };
};
