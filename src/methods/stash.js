module.exports = function (instance, common) {
  var obj = {
    ...
    create: function (Stash, cb) {
      // create(Stash[, cb])
      return common.postParams(`/people/${instance.user.username}/stash/create.json`, Stash, cb);
    },
    createPhoto: function (id, params, cb) {
      // createPhoto(id, params[, cb])
      return common.postParams(`/people/${instance.user.username}/stash/${id}/create_photo.json`, params, cb);
    },
    ...
    reorderPhotos: function (id, params, cb) {
      ...
      return common.postParams(`/people/${instance.user.username}/stash/${id}/reorder_photos.json`, params, cb);
    },
