module.exports = function (instance, common) {
  return {
    create: function (QueuedProject, cb) {
      ...
      return common.postParams(`/people/${instance.user.username}/queue/create.json`, QueuedProject, cb);
    },
    ...
    reposition: function (id, params, cb) {
      ...
      return common.postParams(`/people/${instance.user.username}/queue/${id}/reposition.json`, params, cb);
    },
    ...
    update: function (id, QueuedProject, cb) {
      ...
      return common.postParams(`/people/${instance.user.username}/queue/${id}/update.json`, QueuedProject, cb);
    }
  };
};
