module.exports = function (instance, common) {
  return {
    ...
    create: function (params, cb) {
      // create(params[, cb])
      return common.postParams(`/people/${instance.user.username}/friends/create.json`, params, cb);
    },
    destroy: function (id, cb) {
      // destroy(id[, cb])
      return common.post(`/people/${instance.user.username}/friends/${id}/destroy.json`, cb);
    },
